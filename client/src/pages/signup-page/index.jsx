  ...
  useEffect(() => {
    ...
    <div className="flex flex-col justify-center">
      <div className="rounded-lg bg-white w-80 text-center p-2 h-max px-4">
        ...
        }} placeholder="Dayalani" label={"Username"} />
        <InputBox onChange={(e) => {
        ...
        }} placeholder="Chinaar" label={"Codforces Handle"} />
        <InputBox onChange={(e) => {
          setGithubHandle(e.target.value);
        }} placeholder="Chinaar" label={"Github Handle"} isImportant={false} />
        <InputBox onChange={(e) => {
          setLinkedInHandle(e.target.value);
        }} placeholder="Chinaar" label={"LinkedIn Handle"} isImportant={false} />
        <div className="pt-4">
